/** 1105.)  You are given an array books where books[i] = [thicknessi, heighti] indicates the thickness and height of the ith book. 
...
then build another level of the shelf of the bookcase so that 
...
if we have an ordered list of 5 books, we might place the first and second book onto the first shelf, 
